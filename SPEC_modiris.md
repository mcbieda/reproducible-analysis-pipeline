# modiris.md - a specification document for the program iris-modification.py
...
# OUTPUTS
 ...
 - data_derived/iris-basicmod.csv
 ...
 - data_derived/iris-combined.csv
 	- combine iris-basicmod.csv and iris-simdata.csv to make one file. 
